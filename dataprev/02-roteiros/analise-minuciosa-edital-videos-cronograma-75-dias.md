# Análise minuciosa e cronograma revisado — DATAPREV 2026

## Perfil analisado

**Analista de Tecnologia da Informação — Perfil 3: Desenvolvimento de Software**

- Período: **28/07/2026 a 10/10/2026 (75 dias)**.
...
Fonte: [Edital DATAPREV nº 001/2026 — FGV](https://conhecimento.fgv.br/sites/default/files/concursos/edital-dataprev_supe-versao-final.pdf).

| Bloco | Questões | Peso | Pontos | Parcela da nota |
|---|---:|---:|---:|---:|
| Conhecimentos específicos | 30 | 2,5 | 75 | 65,2% |
| Português | 12 | 1 | 12 | 10,4% |
| Inglês | 12 | 1 | 12 | 10,4% |
| Raciocínio Lógico | 5 | 1 | 5 | 4,4% |
| Atualidades + IA | 6 | 1 | 6 | 5,2% |
| Legislação | 5 | 1 | 5 | 4,4% |

A aprovação exige **57,5 pontos** e o candidato **não pode zerar nenhuma disciplina**. Por isso, o plano reserva a maior parte dos vídeos aos conhecimentos específicos, mas mantém contato recorrente com todas as disciplinas gerais. Português e Inglês também são critérios de desempate depois da nota específica.

## Método usado para classificar cada vídeo

- **Núcleo obrigatório:** título correspondente diretamente a um item do edital.
- **Apoio:** correção de questões e revisão; útil depois da teoria, mas não ocupa a fila principal de vídeos.
- **Dispensado por domínio prévio:** lógica de programação e introduções básicas já dominadas.
- **Redundante:** IA repetida dentro de Banco de Dados, quando já existe disciplina própria.
- **Somente PDF:** tópicos expressos no edital sem vídeo disponível: ecologia, problemas geométricos, data mining, banco em memória e sistemas de suporte à decisão.

A seleção não usa mais intervalos genéricos. Cada item diário abaixo é o **título exato do vídeo** e fica vinculado à aula correspondente no site.

## Cobertura módulo a módulo

| Disciplina | Módulo | Vídeos | Núcleo | Apoio/prática | Decisão |
|---|---|---:|---:|---:|---|
| Atualidades | Aula 01 — Panorama Internacional – I | 10 | 2 | 2 | Seletiva |
| Atualidades | Aula 02 — Panorama Internacional - II | 7 | 1 | 6 | Seletiva |
| Atualidades | Aula 08 — Retrospectiva de Atualidades - Abril de 2026 | 7 | 2 | 0 | Seletiva |
| Atualidades | Aula 09 — Simulado de Atualidades - Abril de 2026 | 4 | 0 | 4 | Prática após teoria |
| Atualidades | Aula 10 — Retrospectiva de Atualidades - Maio de 2026 | 9 | 2 | 0 | Seletiva |
| Atualidades | Aula 11 — Simulado de Atualidades - Maio de 2026 | 3 | 0 | 3 | Prática após teoria |
| Atualidades | Aula 12 — Retrospectiva de Atualidades - Junho de 2026 | 7 | 1 | 0 | Seletiva |
| Atualidades | Aula 13 — Simulado de Atualidades - Junho de 2026 | 4 | 0 | 4 | Prática após teoria |
| Inteligência Artificial | Aula 01 — Inteligência Artificial: fundamentos e aplicações: conceitos de inteligência artificial; aprendizado da máquina; introdução aos modelos generativos e modelos de linguagem; ética, governança e privacidade em IA. | 8 | 4 | 0 | Seletiva |
| Legislação Acerca da Segurança da Informação e Proteção de Dados | Aula 01 — Lei nº 12.965/2014 (Marco Civil da Internet): capítulos II e III, Seções I e II. | 11 | 6 | 1 | Seletiva |
| Legislação Acerca da Segurança da Informação e Proteção de Dados | Aula 02 — Lei nº 12.527/2011 (Lei de Acesso à Informação): capítulos I, II, III, IV e V; Dec. nº 7.724 | 5 | 4 | 1 | Seletiva |
| Legislação Acerca da Segurança da Informação e Proteção de Dados | Aula 03 — Lei nº 12.737/2012 (Lei de Delitos Informáticos): art. 2º. | 1 | 1 | 0 | Integral |
| Legislação Acerca da Segurança da Informação e Proteção de Dados | Aula 04 — Lei nº 13.709/2018 (Lei Geral de Proteção de Dados Pessoais – LGPD): capítulos I, II, III, IV, VII, VIII e IX. | 20 | 4 | 2 | Seletiva |
| Língua Inglesa | Aula 01 — Introdução: às técnicas de leitura Scanning e Skimming;  à importância dos tempos verbais em inglês; ao uso dos falsos cognatos; aos termos gramaticais essenciais; ao uso de expressões idiomáticas e às formas de interpretar imagens. | 2 | 2 | 0 | Integral |
| Língua Inglesa | Aula 02 — Scanning; Skimming; Cognates (Cognatos), False Cognates (Falsos Cognatos) Idioms (expressões idiomáticas). | 4 | 3 | 0 | Seletiva |
| Língua Inglesa | Aula 03 — Verb To be (Verbo To be); Simple Present (Presente Simples); Simple Past (Passado Simples); Future Will x  Going to (Futuro com Will x Going to); Gerund (Gerúndio); Present Continuous (Presente Contínuo); Past Continuous (Passado Contínuo); Present Perfect (Presente Perfeito); Past Perfect (Passado Perfeito); Future Perfect (Futuro Perfeito); Present Perfect Continuous (Presente Perfeito Contínuo); Past Perfect Continuous (Passado Perfeito Contínuo); Future Perfect Continuous (Futuro Perfeito Contínuo); Modal Verbs (Verbos Modais); Imperative Tenses (Imperativo) e Phrasal Verbs (Verbos Frasais). | 3 | 2 | 1 | Seletiva |
| Língua Inglesa | Aula 04 — Definite Articles (Artigos definidos); Indefinite Articles (Artigos indefinidos); Nouns (Substantivos); Common Noun (Substantivo Comum); Proper Noun (Substantivo Próprio) Compound Noun (Substantivo Composto); Abstract and Concrete Nouns (Substantivos Abstratos e Concretos); Collective Nouns. (Substantivos Coletivos); Countable and Uncountable Nouns (Substantivos Contáveis e Incontáveis); Plural (Regular e Irregular); Numbers (Números); Prefixes (Prefixos) e Sufixes (Sufixos) | 4 | 3 | 0 | Seletiva |
| Língua Inglesa | Aula 05 — Adjectives (Adjetivos); Comparative (Grau Comparativo); Superlative (Grau Superlativo); Adverbs (Advérbios); Adverbs of Manner (Advérbios de Modo); Adverbs of Frequency (Advérbios de Frequência); Adverbs of Time (Advérbios de Tempo); Adverbs of Place (Advérbios de Lugar) e Adverbs of Intensity (Advérbios de Intensidade). | 3 | 3 | 0 | Integral |
| Língua Inglesa | Aula 06 — Pronouns (Pronomes); Personal Pronouns (Pronomes Pessoais); Possessive Pronouns (Pronomes Possessivos); Subject Pronouns (Pronomes Sujeitos); Object Pronouns (Pronomes Objeto); Adjective Pronouns (Pronomes Adjetivos); Reflexive Pronouns (Pronomes Reflexivos); Demonstrative Pronouns (Pronomes Demonstrativos); Indefinite Pronouns (Pronomes Indefinidos); Interrogative Pronouns (Pronomes Interrogativos); Prepositions (Preposições) e Conjunctions (Conjunções). | 6 | 3 | 3 | Seletiva |
| Língua Inglesa | Aula 07 — Direct Speech (Discurso Direto); Reported Speech (Discurso Indireto); Active Voice (Voz Ativa) e Passive Voice (Voz Passiva). | 2 | 2 | 0 | Integral |
| Língua Inglesa | Aula 08 — Conditionals (Orações Condicionais); Zero Conditional; First Conditional; Second Conditional; Third Conditional e Quantifiers (Determinantes/Quantificadores). | 2 | 2 | 0 | Integral |
| Língua Portuguesa | Aula 02 — Ortografia oficial. | 14 | 0 | 6 | PDF, diagnóstico ou fim da fila |
| Língua Portuguesa | Aula 03 — Classes de palavras: substantivos, adjetivos, pronomes, artigos, numerais, advérbios e interjeições. Colocação dos pronomes átonos. | 45 | 0 | 20 | PDF, diagnóstico ou fim da fila |
| Língua Portuguesa | Aula 04 — Classes de palavras: preposições e conjunções. | 13 | 0 | 2 | PDF, diagnóstico ou fim da fila |
| Língua Portuguesa | Aula 05 — Classes de palavras: verbos. Emprego de tempos e modos verbais. | 46 | 0 | 19 | PDF, diagnóstico ou fim da fila |
| Língua Portuguesa | Aula 06 — Estrutura morfossintática do período. Relações de coordenação e subordinação entre orações e entre termos da oração. | 47 | 4 | 12 | Seletiva |
| Língua Portuguesa | Aula 07 — Emprego dos sinais de pontuação. | 18 | 2 | 11 | Seletiva |
| Língua Portuguesa | Aula 08 — Concordância verbal e nominal. | 15 | 2 | 7 | Seletiva |
| Língua Portuguesa | Aula 09 — Regência verbal e nominal. Emprego do sinal indicativo de crase. | 20 | 2 | 10 | Seletiva |
| Língua Portuguesa | Aula 10 — Mecanismos de coesão textual. Emprego de elementos de referenciação, substituição e repetição, de conectores e de outros elementos de sequenciação textual. Reescrita de frases e parágrafos do texto. | 30 | 4 | 9 | Seletiva |
| Língua Portuguesa | Aula 11 — Significação das palavras. Substituição de palavras ou de trechos de texto. | 25 | 0 | 9 | PDF, diagnóstico ou fim da fila |
| Língua Portuguesa | Aula 12 — Compreensão e interpretação de textos de gêneros variados. Tipos e gêneros textuais. Reorganização da estrutura de orações e de períodos do texto. Reescrita de textos de diferentes gêneros e níveis de formalidade. | 59 | 4 | 28 | Seletiva |
| Raciocínio Lógico | Aula 01 — Estruturas Lógicas I | 19 | 3 | 3 | Seletiva |
| Raciocínio Lógico | Aula 02 — Estruturas Lógicas II | 28 | 3 | 6 | Seletiva |
| Raciocínio Lógico | Aula 03 — Equivalências e Negações Lógicas | 11 | 3 | 3 | Seletiva |
| Raciocínio Lógico | Aula 04 — Diagramas Lógicos | 13 | 2 | 7 | Seletiva |
| Raciocínio Lógico | Aula 05 — Lógica de Primeira Ordem | 5 | 2 | 1 | Seletiva |
| Raciocínio Lógico | Aula 06 — Lógica de Argumentação | 18 | 3 | 4 | Seletiva |
| Raciocínio Lógico | Aula 07 — Argumentos: Estrutura Básica e Classificação | 3 | 2 | 1 | Seletiva |
| Raciocínio Lógico | Aula 08 — Problemas de Lógica I | 11 | 0 | 8 | PDF, diagnóstico ou fim da fila |
| Raciocínio Lógico | Aula 09 — Problemas de Lógica II | 7 | 0 | 3 | PDF, diagnóstico ou fim da fila |
...
| Banco de Dados | Aula 06 — 05 INTELIGÊNCIA DE NEGÓCIOS (BUSINESS INTELLIGENCE): Conceitos, fundamentos, características, técnicas e métodos de business intelligence (BI). Arquitetura e aplicações de data warehouse com ETL. Definições e conceitos de data warehouse. Mapeamento das fontes de dados: técnicas para coleta de dados. Arquitetura de business intelligence. Técnicas de Integração e Ingestão de Dados (ETL/ELT, Transferência de Arquivos e Integração via Base de Dados). Data lakes. Análise de Dados. Felipe Mathias, Emannuelle Gouveia | 9 | 4 | 0 | Seletiva |
| Banco de Dados | Aula 07 — 06 OLAP. Visualização de dados: BD individuais e cubos. Modelagem dimensional. Abordagem multidimensional. Felipe Mathias, Emannuelle Gouveia | 9 | 4 | 0 | Seletiva |
| Banco de Dados | Aula 08 — 07 Soluções para big data. Felipe Mathias, Emannuelle Gouveia | 10 | 2 | 2 | Seletiva |
| Banco de Dados | Aula 10 — 09 Banco de dados NoSQL. Felipe Mathias, Emannuelle Gouveia | 4 | 2 | 0 | Seletiva |
| Banco de Dados | Aula 12 — 11 Conceitos de Inteligência Artificial. Lucas Ianni | 7 | 0 | 0 | PDF, diagnóstico ou fim da fila |
| Desenvolvimento de Software | Aula 01 — Lógica de Programação [não explícito no edital] | 14 | 0 | 1 | PDF, diagnóstico ou fim da fila |
| Desenvolvimento de Software | Aula 02 — 01 Arquitetura e linguagem orientada a objetos. | 10 | 5 | 3 | Seletiva |
| Desenvolvimento de Software | Aula 03 — 02 Desenvolvimento de sistemas. Desenvolvimento em Linguagens de programação Java (versão 6 ou superior). | 22 | 7 | 5 | Seletiva |
| Desenvolvimento de Software | Aula 04 — 03 JavaEE (versão 6 ou superior), JakartaEE, JSF, Primefaces. | 9 | 2 | 7 | Seletiva |
| Desenvolvimento de Software | Aula 05 — 04 JPA (versão 2 ou superior), Hibernate | 7 | 5 | 2 | Seletiva |
...
| Desenvolvimento de Software | Aula 21 — 20 Blockchain. Transações distribuídas. | 2 | 1 | 1 | Seletiva |
| Desenvolvimento de Software | Aula 22 — 21 Desenvolvimento para dispositivos móveis (Android e iOs). | 13 | 3 | 0 | Seletiva |
| Engenharia de Software | Aula 01 — Tipos de Abordagem: tradicional, hibrida. | 15 | 3 | 4 | Seletiva |
| Engenharia de Software | Aula 02 — 01 Metodologias Ágeis de Desenvolvimento. Ágil (Metodologia Lean); | 3 | 3 | 0 | Integral |
| Engenharia de Software | Aula 03 — 02 Scrum. Guia Scrum de prática ágil para gerenciamento de projetos. Story Points. | 15 | 3 | 2 | Seletiva |
| Engenharia de Software | Aula 04 — 03 XP. | 4 | 1 | 3 | Seletiva |
| Engenharia de Software | Aula 05 — 04 Kanban; Método Kanban; Test-driven development (TDD) | 3 | 3 | 0 | Integral |
| Engenharia de Software | Aula 06 — 05 Engenharia de Requisitos. Classificação de Requisitos. Processo de Engenharia de Requisitos. Técnicas de Elicitação de Requisitos. | 14 | 7 | 4 | Seletiva |
| Engenharia de Software | Aula 07 — 06 TESTES: conceitos básicos de testes de aplicações. Testes unitários. Testes de integração. Testes ágeis. Teste de usabilidade de software. Testes automatizados. Tipos de testes. Gestão do ciclo de vida de testes. RPA (robotic process automation). | 16 | 7 | 5 | Seletiva |
| Engenharia de Software | Aula 08 — 07 Arquitetura de aplicações para ambiente web. Arquitetura de software. Arquitetura hexagonal, microsserviços. Servidor de aplicações. Servidor web. | 17 | 7 | 6 | Seletiva |
| Engenharia de Software | Aula 09 — 08 Interoperabilidade de sistemas. Arquitetura e linguagem orientada a serviços. | 4 | 4 | 0 | Integral |
| Engenharia de Software | Aula 10 — 09 Web services. API. | 10 | 6 | 4 | Seletiva |
| Engenharia de Software | Aula 11 — 10 Metodologia de Ponto de Função. | 7 | 3 | 0 | Seletiva |
| Engenharia de Software | Aula 12 — 11 Padrões de desenvolvimento e reuso. | 15 | 7 | 0 | Seletiva |
| Engenharia de Software | Aula 13 — 12 Desenvolvimento em ferramentas low-code e no-code. Design de software. | 2 | 2 | 0 | Integral |
| Engenharia de Software | Aula 14 — 13 User Experience (UX). Desenho e planejamento de interação em aplicações web. | 7 | 3 | 0 | Seletiva |
| Engenharia de Software | Aula 15 — 14 Sistemas de gestão de conteúdo. Conceitos básicos e aplicações. Arquitetura de informação. | 2 | 2 | 0 | Integral |
| Engenharia de Software | Aula 16 — 15 Portais corporativos. Conceitos básicos e aplicações. Workflow. | 8 | 3 | 0 | Seletiva |
| Engenharia de Software | Aula 17 — 16 Conceitos de acessibilidade e usabilidade. | 8 | 3 | 0 | Seletiva |
| Engenharia de Software | Aula 19 — 18 Ambientes Internet, extranet, intranet e portal: finalidades, características físicas e lógicas, aplicações e serviços. | 2 | 2 | 0 | Integral |
...
| Segurança da Informação | Aula 03 — 02 Políticas de segurança da informação. Normas ABNT NBR ISO/IEC 27001:2022 e ABNT NBR ISO/IEC 27002:2022. | 23 | 4 | 0 | Seletiva |

## Rotina de cada dia comum

- **Até 150 min brutos:** vídeos listados. Em 1,5×, normalmente ocuparão cerca de 100 minutos.
- **30 min:** questões no NotebookLM e correção.
- **Tempo restante até 3h:** pausas, anotações e revisão espaçada.

Nenhum dia ultrapassa 150 minutos de duração bruta dos vídeos. As durações vêm dos metadados do próprio Google Drive.

## Cronograma exato dos 75 dias

### Fase — Fundamentos de maior valor: requisitos, testes, segurança e arquitetura

#### Dia 1 — 28/07/2026

- [Vídeo · 23 min] **Engenharia de Software · Aula 06** — Introdução - Engenharia de Requisitos
- [Vídeo · 15 min] **Engenharia de Software · Aula 06** — Classificações de requisitos - Parte 01
- [Vídeo · 16 min] **Engenharia de Software · Aula 06** — Classificações de requisitos - Parte 02
- [Vídeo · 7 min] **Engenharia de Software · Aula 06** — Estudo de Viabilidade
- [Vídeo · 24 min] **Engenharia de Software · Aula 06** — Elicitação e Análise de Requisitos
- [Vídeo · 8 min] **Legislação Acerca da Segurança da Informação e Proteção de Dados · Aula 01** — Apresentação do Curso
- [Vídeo · 19 min] **Legislação Acerca da Segurança da Informação e Proteção de Dados · Aula 01** — Marco civil da internet (MCI) Lei nº 12.965/2014
- [Vídeo · 26 min] **Engenharia de Software · Aula 06** — Casos de Uso
- **Questões:** 30 minutos no NotebookLM sobre os tópicos do dia, com correção ativa.

#### Dia 2 — 29/07/2026

- [Vídeo · 5 min] **Engenharia de Software · Aula 06** — Análise de Requisitos
- [Vídeo · 15 min] **Engenharia de Software · Aula 07** — Testes de Software
- [Vídeo · 20 min] **Engenharia de Software · Aula 07** — Abordagens de Testes
- [Vídeo · 8 min] **Engenharia de Software · Aula 07** — Estágios de Teste
- [Vídeo · 16 min] **Legislação Acerca da Segurança da Informação e Proteção de Dados · Aula 01** — MCI - Definições
- [Vídeo · 16 min] **Legislação Acerca da Segurança da Informação e Proteção de Dados · Aula 01** — MCI - Direitos e garantias dos usuários
- [Vídeo · 7 min] **Engenharia de Software · Aula 07** — Abordagem Caixa Branca
- [Vídeo · 5 min] **Engenharia de Software · Aula 07** — Teste de Integração
- **Questões:** 30 minutos no NotebookLM sobre os tópicos do dia, com correção ativa.

#### Dia 3 — 30/07/2026

- [Vídeo · 8 min] **Engenharia de Software · Aula 07** — Teste de Aceitação
- [Vídeo · 5 min] **Engenharia de Software · Aula 07** — Teste de Sistema
- [Vídeo · 40 min] **Segurança da Informação · Aula 01** — Princípios da Segurança da Informação - Parte 01
- [Vídeo · 15 min] **Legislação Acerca da Segurança da Informação e Proteção de Dados · Aula 01** — MCI - Neutralidade da rede
- [Vídeo · 11 min] **Legislação Acerca da Segurança da Informação e Proteção de Dados · Aula 01** — MCI - Proteção Aos Registros, Aos Dados Pessoais e Às Comunicações Privadas
- [Vídeo · 30 min] **Segurança da Informação · Aula 01** — Princípios da Segurança da Informação - Parte 02
- [Vídeo · 35 min] **Segurança da Informação · Aula 01** — Segurança Física, Lógica e Controle de Acesso - Parte 01
- [Vídeo · 8 min] **Legislação Acerca da Segurança da Informação e Proteção de Dados · Aula 04** — Lgpd: Fundamentos
- **Questões:** 30 minutos no NotebookLM sobre os tópicos do dia, com correção ativa.

#### Dia 4 — 31/07/2026

- [Vídeo · 16 min] **Segurança da Informação · Aula 01** — Segurança Física, Lógica e Controle de Acesso - Parte 02
- [Vídeo · 27 min] **Segurança da Informação · Aula 01** — Autenticação e seus Mecanismos - Parte 01
- [Vídeo · 27 min] **Segurança da Informação · Aula 01** — Autenticação e seus Mecanismos - Parte 02
- [Vídeo · 45 min] **Legislação Acerca da Segurança da Informação e Proteção de Dados · Aula 02** — Lei de Acesso à Informação - noções iniciais
- [Vídeo · 15 min] **Legislação Acerca da Segurança da Informação e Proteção de Dados · Aula 02** — Procedimento de Acesso à Informação
- [Vídeo · 18 min] **Segurança da Informação · Aula 02** — HTTP - Parte 01
- **Questões:** 30 minutos no NotebookLM sobre os tópicos do dia, com correção ativa.

#### Dia 5 — 01/08/2026

- [Vídeo · 52 min] **Segurança da Informação · Aula 01** — SAML, OAuth2, OpenID e KeyCloak
- [Vídeo · 19 min] **Segurança da Informação · Aula 02** — HTTP - Parte 02
- [Vídeo · 22 min] **Segurança da Informação · Aula 02** — HTTP - Parte 03 - Métodos
- [Vídeo · 22 min] **Segurança da Informação · Aula 02** — HTTP - Parte 04 - Códigos de Estado
- [Vídeo · 21 min] **Legislação Acerca da Segurança da Informação e Proteção de Dados · Aula 02** — Restrições ao Acesso
- [Vídeo · 10 min] **Legislação Acerca da Segurança da Informação e Proteção de Dados · Aula 02** — Responsabilidade dos Agentes
- **Questões:** 30 minutos no NotebookLM sobre os tópicos do dia, com correção ativa.

#### Dia 6 — 02/08/2026

- [Vídeo · 27 min] **Segurança da Informação · Aula 02** — HTTP - Parte 05 - Cache e Proxy
- [Vídeo · 19 min] **Segurança da Informação · Aula 02** — HTTP - Parte 06 - HTTPS
- [Vídeo · 25 min] **Segurança da Informação · Aula 02** — HTTP - Parte 07 - Versoes 2.0 e 3.0
- [Vídeo · 19 min] **Engenharia de Software · Aula 08** — Projeto e Arquitetura de Software
- [Vídeo · 28 min] **Engenharia de Software · Aula 08** — O que constitui uma boa arquitetura?
- [Vídeo · 12 min] **Legislação Acerca da Segurança da Informação e Proteção de Dados · Aula 03** — Lei de Delitos Informáticos - Lei nº 12.737/2012
- [Vídeo · 12 min] **Legislação Acerca da Segurança da Informação e Proteção de Dados · Aula 04** — Lgpd: Noções Iniciais
- [Vídeo · 11 min] **Engenharia de Software · Aula 08** — Arquitetura WEB
- **Questões:** 30 minutos no NotebookLM sobre os tópicos do dia, com correção ativa.

#### Dia 7 — 03/08/2026

- **Revisão 1 — requisitos, testes e segurança** (180 min): Revisão ativa, caderno de erros e questões FGV dos assuntos estudados.

#### Dia 8 — 04/08/2026

- [Vídeo · 18 min] **Engenharia de Software · Aula 08** — Arquitetura em Camadas
- [Vídeo · 24 min] **Engenharia de Software · Aula 08** — Arquitetura em três camadas
- [Vídeo · 18 min] **Engenharia de Software · Aula 08** — Arquitetura MVC
- [Vídeo · 20 min] **Engenharia de Software · Aula 08** — Arquitetura Distribuída
- [Vídeo · 25 min] **Legislação Acerca da Segurança da Informação e Proteção de Dados · Aula 04** — Lgpd: Disposições Gerais
- [Vídeo · 29 min] **Engenharia de Software · Aula 09** — SOA - Conceitos Básicos
- [Vídeo · 13 min] **Engenharia de Software · Aula 09** — SOA - Princípios Básicos
- **Questões:** 30 minutos no NotebookLM sobre os tópicos do dia, com correção ativa.

#### Dia 9 — 05/08/2026

- [Vídeo · 12 min] **Engenharia de Software · Aula 09** — SOA - Modelos de Arquitetura
- [Vídeo · 18 min] **Engenharia de Software · Aula 09** — SOA - Tecnologias de integração e Comunicação e CORBA
- [Vídeo · 15 min] **Engenharia de Software · Aula 10** — Web Services - Conceitos
- [Vídeo · 8 min] **Legislação Acerca da Segurança da Informação e Proteção de Dados · Aula 04** — LGPD: Princípios
- [Vídeo · 64 min] **Inteligência Artificial · Aula 01** — Inteligência Artificial: Conceitos Básicos - Aula 1
- [Vídeo · 9 min] **Engenharia de Software · Aula 10** — Web Services - SOAP
- [Vídeo · 9 min] **Engenharia de Software · Aula 10** — Web Services - WSDL
- [Vídeo · 8 min] **Engenharia de Software · Aula 10** — Web Services -UDDI
- **Questões:** 30 minutos no NotebookLM sobre os tópicos do dia, com correção ativa.

#### Dia 10 — 06/08/2026

- [Vídeo · 27 min] **Engenharia de Software · Aula 10** — Web Services - HTTP
- [Vídeo · 26 min] **Engenharia de Software · Aula 10** — Web Services - REST
- [Vídeo · 20 min] **Inteligência Artificial · Aula 01** — Inteligência Artificial: Tipos de IA (forte e Fraca) - Aula 2
...
- [Vídeo · 26 min] **Engenharia de Software · Aula 12** — Padrões Criacionais - Abstract Factory, Builder e Factory Method
- [Vídeo · 26 min] **Engenharia de Software · Aula 12** — Padrões Criacionais - Prototype e Singleton
- [Vídeo · 26 min] **Engenharia de Software · Aula 12** — Padrões Estruturais - Adapter e Bridge
- [Vídeo · 41 min] **Inteligência Artificial · Aula 01** — Inteligência Artificial: Riscos e Desafios - Aula 4
- [Vídeo · 26 min] **Engenharia de Software · Aula 12** — Padrões Estruturais - Composite, Decorator e Proxy
- **Questões:** 30 minutos no NotebookLM sobre os tópicos do dia, com correção ativa.
...
- **Revisão 2 — arquitetura e Java** (180 min): Revisar mapas próprios e resolver questões, corrigindo cada alternativa.

### Fase — Ecossistema Java, qualidade, frontend e entrega
...
- [Vídeo · 113 min] **Desenvolvimento de Software · Aula 05** — ORM/JPA/HIBERNATE - Parte 01 - Introdução e Motivação para o uso de um ORM
- [Vídeo · 30 min] **Língua Portuguesa · Aula 08** — Concordância Verbal - Parte 02
- **Questões:** 30 minutos no NotebookLM sobre os tópicos do dia, com correção ativa.
...
- **Revisão 3 — ecossistema Java e frontend** (180 min): Revisão acumulada e questões de conhecimentos específicos.
...
- **Simulado parcial 1** (240 min): 70 questões no formato da prova; corrigir e classificar erros por disciplina.

### Fase — Dados, BI, integração, governança e normas
...
- **Revisão 4 — dados, BI e integração** (180 min): Revisão de banco de dados e questões específicas.
...
- **PDF — Sistemas de suporte à decisão** (30 min): Conteúdo expresso no bloco de BI sem videoaula no catálogo.
- [Vídeo · 26 min] **Desenvolvimento de Software · Aula 19** — Mensageria - Parte 03
...
- **Simulado parcial 2** (240 min): 70 questões em até quatro horas, com controle do tempo por bloco.

### Fase — Conhecimentos gerais e fechamento das lacunas específicas
...
- **PDF — Ecologia e desenvolvimento sustentável** (35 min): Tema explícito de Atualidades sem videoaula no catálogo.
- [Vídeo · 81 min] **Banco de Dados · Aula 02** — Modelo Relacional - Parte 1
- [Vídeo · 65 min] **Banco de Dados · Aula 02** — Modelo Relacional - Parte 2
- **Questões:** 30 minutos no NotebookLM sobre os tópicos do dia, com correção ativa.
...
- **Simulado completo 1** (240 min): Reproduzir as condições da prova das 13h às 17h.

#### Dia 50 — 15/09/2026

- **Correção do simulado completo 1** (180 min): Corrigir integralmente e reassistir apenas lacunas graves.
...
- **Revisão 5 — conhecimentos gerais** (180 min): Português, Inglês, RLM, leis, IA e atualidades.

### Fase — Consolidação, questões e revisão orientada por desempenho
...
- **Simulado completo 2** (240 min): 70 questões em quatro horas, sem consulta e com cartão-resposta.

#### Dia 64 — 29/09/2026

- **Correção do simulado completo 2** (180 min): Atualizar a lista das dez maiores lacunas e revisar cada erro.
...
- **Último simulado completo** (240 min): Último ensaio integral, no mesmo horário da prova.

#### Dia 72 — 07/10/2026

- **Correção final orientada por erros** (180 min): Revisar somente os erros do último simulado e recorrências.

#### Dia 73 — 08/10/2026

- **Revisão final — conhecimentos específicos** (180 min): Requisitos, testes, arquitetura, Java, dados, segurança e governança.

#### Dia 74 — 09/10/2026

- **Revisão final — conhecimentos gerais** (180 min): Português, Inglês, RLM, legislação, IA e atualidades.

#### Dia 75 — 10/10/2026

- **Véspera leve** (90 min): No máximo 90 minutos: fórmulas, leis marcadas, documentos e descanso.

## Auditoria final de lacunas

O catálogo não oferece videoaula para alguns itens expressos no edital. Eles foram incluídos como leitura de PDF, mas devem ser conferidos nos PDFs do curso: **ecologia e desenvolvimento sustentável, problemas geométricos, data mining, banco de dados em memória e sistemas de suporte à decisão**. Atualidades de julho a setembro também exigem material novo próximo à prova.

Os vídeos de questões retirados da fila principal não foram considerados inúteis: devem ser usados seletivamente quando a taxa de acerto do tópico ficar abaixo de 70%.

## Regras de ajuste por desempenho

- **≥ 85% em duas baterias:** manter apenas revisão espaçada.
- **70% a 84%:** corrigir erros e fazer nova bateria em sete dias.
- **< 70%:** assistir aos vídeos de questões/correção do módulo e voltar ao PDF.
- **Zero em qualquer disciplina no simulado:** essa disciplina recebe pelo menos 30 minutos diários até sair da zona de risco.
- Não iniciar conteúdo novo depois do dia 70.

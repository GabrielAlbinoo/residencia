...
```text
08-aulas/aulas-md/14-contadores_assincronos_sincronos_divisao_frequencia.md
```
...
```text
08-aulas/aulas-md/        -> versão .md
08-aulas/aulas-pdf/       -> versão .pdf formatada
08-aulas/aulas-pdf-clean/ -> cópia .pdf formatada
```

Ou seja: salve uma cópia da aula em `.md` na pasta `08-aulas/aulas-md` e salve cópias em `.pdf` nas pastas `08-aulas/aulas-pdf` e `08-aulas/aulas-pdf-clean`.

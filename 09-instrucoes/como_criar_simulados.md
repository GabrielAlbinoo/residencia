...
```text
03-simulados/simulados-html/modelo_simulado_base.html
```

Crie uma cópia com nome claro:

```text
03-simulados/simulados-html/simulado_NN_assunto_quantidade_questoes.html
```

Exemplo:

```text
03-simulados/simulados-html/simulado_04_aulas_10_a_14_nivel_prova_50_questoes.html
```
...
arquivo salvo em 03-simulados/simulados-html/
```
